...
char *test_remove_prefixes_runs_3_times() 
{
  ...
  debug("Removal 1 expected => original_word: diberberlari, removed_part: di | actual => original_word: %s, removed_part: %s", removals[0].original_word, removals[0].removed_part);
  ...
  debug("Removal 2 expected => original_word: berberlari, removed_part: ber | actual => original_word: %s, removed_part: %s", removals[1].original_word, removals[1].removed_part);
  ...
  debug("Removal 3 expected => original_word: berlari, removed_part: ber | actual => original_word: %s, removed_part: %s", removals[2].original_word, removals[2].removed_part);
