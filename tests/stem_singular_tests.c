...
char *test_stem_singular_word_removes_complex_prefixes_23() 
{
  return test_stem_singular_word_for("pertahan", "tahan");
}

char *test_stem_singular_word_removes_complex_prefixes_24() 
{
...
char *test_stem_singular_word_removes_complex_prefixes_27() 
{
...
char *test_stem_singular_word_removes_complex_prefixes_29() 
{
