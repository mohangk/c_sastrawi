...
char *test_remove_complex_prefix_rule27_fully_stemmed_c() 
{
  return test_remove_complex_prefix("pencari", "cari", "pen", FULLY_STEMMED, remove_complex_prefix_rule27);
}

char *test_remove_complex_prefix_rule27_fully_stemmed_d() 
{
  return test_remove_complex_prefix("pendaki", "daki", "pen", FULLY_STEMMED, remove_complex_prefix_rule27);
}

char *test_remove_complex_prefix_rule27_fully_stemmed_j() 
{
  return test_remove_complex_prefix("penjual", "jual", "pen", FULLY_STEMMED, remove_complex_prefix_rule27);
}

char *test_remove_complex_prefix_rule28a_fully_stemmed() 
{
  return test_remove_complex_prefix("penilai", "nilai", "pe", FULLY_STEMMED, remove_complex_prefix_rule28);
}

char *test_remove_complex_prefix_rule28b_fully_stemmed() 
{
  return test_remove_complex_prefix("penari", "tari", "pe", FULLY_STEMMED, remove_complex_prefix_rule28);
}

char *test_remove_complex_prefix_rule29_fully_stemmed_g() 
{
  return test_remove_complex_prefix("pengganti", "ganti", "peng", FULLY_STEMMED, remove_complex_prefix_rule29);
}

char *test_remove_complex_prefix_rule29_fully_stemmed_h() 
{
  return test_remove_complex_prefix("penghajar", "hajar", "peng", FULLY_STEMMED, remove_complex_prefix_rule29);
}

char *test_remove_complex_prefix_rule29_fully_stemmed_q() 
{
  return test_remove_complex_prefix("pengqasar", "qasar", "peng", FULLY_STEMMED, remove_complex_prefix_rule29);
}

char *test_remove_complex_prefix_rule30a_fully_stemmed() 
{
  return test_remove_complex_prefix("pengalih", "alih", "peng", FULLY_STEMMED, remove_complex_prefix_rule30);
}

char *test_remove_complex_prefix_rule30b_fully_stemmed() 
{
...
char *all_tests()
{
  ...
  mu_run_test(test_remove_complex_prefix_rule27_fully_stemmed_c);
  mu_run_test(test_remove_complex_prefix_rule27_fully_stemmed_j);
  mu_run_test(test_remove_complex_prefix_rule27_fully_stemmed_d);
  mu_run_test(test_remove_complex_prefix_rule28a_fully_stemmed);
  mu_run_test(test_remove_complex_prefix_rule28b_fully_stemmed);
  mu_run_test(test_remove_complex_prefix_rule29_fully_stemmed_g);
  mu_run_test(test_remove_complex_prefix_rule29_fully_stemmed_h);
