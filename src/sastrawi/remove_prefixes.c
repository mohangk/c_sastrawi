...
#define prefix_remover_count 30
const PREFIX_REMOVER prefix_removers[prefix_remover_count] = {
  ...
  remove_complex_prefix_rule26,
  remove_complex_prefix_rule27,
  remove_complex_prefix_rule28,
  remove_complex_prefix_rule29,
  remove_complex_prefix_rule30
};
